    ...
    @if ($step === 'upload')
        <div class="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm dark:border-slate-800 dark:bg-slate-900">
            ...
            <form wire:submit="uploadFile" class="mt-4">
                ...
                <div wire:loading wire:target="file" class="mt-2 text-xs text-slate-500 dark:text-slate-400">Mengunggah &amp; memvalidasi struktur...</div>
                ...
                <table class="w-full text-left text-sm">
                    <thead class="sticky top-0 bg-slate-50 text-xs uppercase tracking-wide text-slate-500 dark:bg-slate-800 dark:text-slate-400">
                        <tr>
                            ...
                            <th scope="col" class="px-4 py-2 font-medium text-right">Penghasilan Kotor</th>
                            <th scope="col" class="px-4 py-2 font-medium text-right">Potongan Pusat</th>
                            <th scope="col" class="px-4 py-2 font-medium text-right">Bersih</th>
            ...
            <div class="mt-6 flex justify-between">
                ...
                @else
                    <x-primary-button
                        ...
                        wire:confirm="Impor data gaji pusat ini ke periode? Data yang sudah diimpor tidak dapat dikembalikan."
    ...
    @if ($step === 'done')
        <div class="rounded-2xl border border-emerald-200 bg-emerald-50 p-6 text-center shadow-sm dark:border-emerald-500/20 dark:bg-emerald-500/10">
            ...
            <div class="mt-6 flex justify-center gap-2">
                ...
                <x-primary-button href="{{ route('salary-periods.show', $periodId) }}" wire:navigate>Lihat Periode</x-primary-button>
            </div>
        </div>
    @endif
</div>
